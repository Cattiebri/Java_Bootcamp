...
public class TenMinWalk {
    /*
        ...
        early to an appointment, so you decided to take the opportunity to go for a short walk.
        ...
        You always walk only a single block in a direction and you know it takes you one minute to traverse one city
        block, so create a function that will return true if the walk the app gives you will take you exactly ten
        minutes (you don't want to be early or late!) and will, of course, return you to your starting point.
